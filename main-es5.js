...
var map = {
	"./create-invoice/create-invoice.module": [
		"./src/app/create-invoice/create-invoice.module.ts",
		"common",
		"create-invoice-create-invoice-module"
	],
	"./edit-invoice/edit-invoice.module": [
...
/* harmony import */ var _services_auth_guard_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/auth-guard/auth-guard.service */ "./src/app/services/auth-guard/auth-guard.service.ts");
...
var routes = [
    ...
    { path: 'home', loadChildren: function () { return Promise.all(/*! import() | home-home-module */[__webpack_require__.e("common"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(function (m) { return m.HomePageModule; }); }, canActivate: [_services_auth_guard_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]] },
    { path: 'login', loadChildren: './login/login.module#LoginPageModule' },
    { path: 'edit-invoice', loadChildren: './edit-invoice/edit-invoice.module#EditInvoicePageModule', canActivate: [_services_auth_guard_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]] },
    { path: 'create-invoice', loadChildren: './create-invoice/create-invoice.module#CreateInvoicePageModule', canActivate: [_services_auth_guard_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]] },
];
...
/* harmony import */ var _services_auth_guard_auth_guard_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./services/auth-guard/auth-guard.service */ "./src/app/services/auth-guard/auth-guard.service.ts");
...
firebase__WEBPACK_IMPORTED_MODULE_15__["initializeApp"](src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].firebase);
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _angular_fire__WEBPACK_IMPORTED_MODULE_17__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].firebase),
                ...
                _angular_service_worker__WEBPACK_IMPORTED_MODULE_9__["ServiceWorkerModule"].register('ngsw-worker.js', { enabled: src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].production })
            ],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
                _services_authentication_authentication_service__WEBPACK_IMPORTED_MODULE_11__["AuthenticationService"],
                _services_auth_guard_auth_guard_service__WEBPACK_IMPORTED_MODULE_12__["AuthGuardService"],
...
var AuthGuardService = /** @class */ (function () {
    function AuthGuardService(authenticationService, navCtrl) {
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyANlJrwTo_EVRll-wfLWjbM5LloXglyQmc",
        authDomain: "expense-tracker-a4f71.firebaseapp.com",
        databaseURL: "https://expense-tracker-a4f71.firebaseio.com",
        projectId: "expense-tracker-a4f71",
        storageBucket: "expense-tracker-a4f71.appspot.com",
        messagingSenderId: "763177675808",
        appId: "1:763177675808:web:9cb5cb1ec656b140a5e045"
    },
};
/*
...
module.exports = __webpack_require__(/*! D:\Coding\Ionic-Angular\expense-tracker\src\main.ts */"./src/main.ts");

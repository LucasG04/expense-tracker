...
let DatabaseService = class DatabaseService {
    ...
    fetchInvoices() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this._invoices.next(yield this.getInvoices());
        });
    }
    fetchCategories() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this._categories = yield this.getCategories();
        });
    }
    get invoices() {
    ...
    getInvoices() {
        return this.invoiceCollection.get().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(snapshot => {
    ...
    getCategories() {
        return this.generalCollection.doc('categories').get().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(snapshot => {
